      ...
      <div className="border-b border-gray-800 px-6 py-4
        ...
        <div>
          ...
          <p className="text-gray-500 text-xs">
            Describe a flow → Get ready Playwright + PyTest code
          </p>
        </div>
      </div>
          ...
          <div>
                ...
                {result.files.map((file, index) => (
                  <button
                    ...
                    className={`px-4 py-3 text-sm font-medium
                               transition-all flex-1 text-left
                               ${activeFile === index
                  ...
                  <div className="flex items-center
                    ...
                    <div>
                      <p className="text-white font-mono text-sm">
                        {result.files[activeFile].filename}
                      </p>
                      <p className="text-gray-500 text-xs mt-1">
                        {result.files[activeFile].description}
                      </p>
                    </div>
            ...
            {result.notes && (
              <div className="bg-yellow-500/10 border
                              border-yellow-500/20 rounded-xl p-5">
