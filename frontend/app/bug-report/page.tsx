      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Write it however you want — messy, casual, incomplete. AI will clean it up into a professional report.
          </p>

          <div className="mb-4">
            <label className="text-sm text-gray-400 mb-2 block">
              Raw Bug Description <span className="text-red-400">*</span>
            </label>
            <textarea
              ...
              rows={5}
              placeholder="Just describe what went wrong in your own words. Example: the login button doesnt work on mobile, tried multiple times, keeps loading forever..."
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                <span className={`text-xs font-medium px-3 py-1 rounded-full border ${getSeverityColor(result.bug_report.severity)}`}>
                  🔴 Severity: {result.bug_report.severity}
                </span>
                <span className={`text-xs font-medium px-3 py-1 rounded-full border ${getPriorityColor(result.bug_report.priority)}`}>
                  ⚡ {result.bug_report.priority}
                </span>
                <span className="text-xs font-medium px-3 py-1 rounded-full border bg-blue-500/20 text-blue-400 border-blue-500/40">
                  🔄 {result.bug_report.reproducibility}
                </span>
                <span className="text-xs font-medium px-3 py-1 rounded-full border bg-gray-500/20 text-gray-400 border-gray-500/40">
                  📌 {result.bug_report.status}
                </span>
              </div>
            </div>
